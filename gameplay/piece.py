from onitama.interface.constants import LOAD_PIECES, PIECES_IMAGES, SQUARE_SIZE, OUTLINECOLOR1, OUTLINECOLOR2, COLORPIECES1, COLORPIECES2, PADDING_KING, PADDING_PAWN, OUTLINE
import pygame
